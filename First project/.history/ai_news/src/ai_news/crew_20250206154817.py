...
class AiNews():
  ...
  @task
	def website_scraper(self) -> Task:
		return Task(
			config=self.tasks_config['website_scraper'],
		)
  @task
	def ai_news_writer(self) -> Task:
		return Task(
			config=self.tasks_config['ai_news_writer'],
		)

	@task
	def file_writer(self) -> Task:
		return Task(
			config=self.tasks_config['reporting_task_task'],
