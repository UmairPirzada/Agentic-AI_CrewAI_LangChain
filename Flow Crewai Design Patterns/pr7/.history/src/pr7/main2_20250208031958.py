...
class CityRoutingFlow(Flow):
    ...
    def classify_city(self):
        ...
        print(f"DEBUG: Selected city from LLM -> {selected_city}")
        ...
        if selected_city in city_routes:
            return city_routes[selected_city]
        else:
            print("DEBUG: Invalid city received, routing to default response.")
