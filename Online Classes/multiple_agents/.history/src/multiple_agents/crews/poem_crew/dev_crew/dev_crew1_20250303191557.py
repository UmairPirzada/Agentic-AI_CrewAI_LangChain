...
class DevCrew:
    ...
    def senior_python_developer(self) -> Agent:
        return Agent(
            ...
            goal="Review the python code Solution witho python type hints and pydocs for this problem: '{problem}'",
            backstory="you are a senior python developer with 20 years of experience",
        )
